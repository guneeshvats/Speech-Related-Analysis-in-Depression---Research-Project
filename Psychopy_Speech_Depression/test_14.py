...
def display_instructions():
    ...
    while True:
        ...
        instructionsHeading.setPos((0, 1.82 + scroll_position))
...
def display_demographic_questions():
    ...
    question_vertical_spacing = 0.5  # Increased space between each question
    ...
    for idx, question_data in enumerate(demographic_questions):
        question_text = visual.TextStim(
            ...
            pos=(0, 0.8 - idx * question_vertical_spacing), height=text_size,
        ...
        for opt_idx, option in enumerate(question_data["options"]):
            button_pos = (-0.4, 0.7 - idx * question_vertical_spacing - opt_idx * option_vertical_spacing)
            option_button = visual.Circle(win, radius=0.03, pos=button_pos, lineColor='black', fillColor=None)
    ...
    while True:
        ...
        for q_idx, question_text in enumerate(question_texts):
            ...
            for opt_idx, option_button in enumerate(option_buttons[q_idx]):
                option_button.setPos((-0.4, 0.7 + scroll_position - q_idx * question_vertical_spacing - opt_idx * option_vertical_spacing))
                option_button.draw()
...
def display_phq9_survey():
    ...
    option_horizontal_spacing = 0.23  
