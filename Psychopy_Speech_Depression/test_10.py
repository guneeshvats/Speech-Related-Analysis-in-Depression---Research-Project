...
    I understand anonymized data can be shared in the public domain with other researchers worldwide.\n\n
    ...
    """, font='Arial', pos=(0, 0), height=0.04, wrapWidth=1.18, color='black', colorSpace='rgb', opacity=1, languageStyle='LTR')
...
def display_instructions():
    ...
    """,
    font='Arial', pos=(0, -1.5), height=0.04, wrapWidth=1.12, color='black', colorSpace='rgb', opacity=1, languageStyle='LTR')
...
def record_audio_dynamic(file_name, fs=44100):
...
def stop_audio_dynamic(stream, audio_data, file_name, fs=44100):
