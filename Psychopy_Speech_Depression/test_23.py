...
To fix : 
1. Instruction of Perception task to dissocicate content and speech                                                                 [DONE]
2. Remove Language Fluency Test from screen and CSV                                                                                 [DONE]
3. Page after I accept consent form - (gievn in reviews)                                                                            [DONE]
4. Fluency in american accent demographic question                                                                                  [DONE]
5. Fix the age question and a line png where they can write (and instruction to click and type)                                     [DONE]
6. Update the SAM scale looks with dotted line and all
7. Insructions for Psychological Demographics                                                                                       [DONE]                                                                                  
8. Allow proper scrolling on page where is problemeatic, options alignemnt                                                          [DONE] 
8.1 allow for prefer to self describe in PD                                                                                         [DONE]
9. Instruction page for PANAS test and correct the instructions                                                                     [DONE]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         on in the PANAS test top [Use what ma'am sent in the MoM]
...
11. Hearing Abilities show second only if first one is dones Yes - (update csv based on that)                  [Explain not possible DONE]
12. Update the info showed on the PHQ and GAD feedback page - sent by ma'am on email                                                [DONE]
13. Paragraphs (60-70 words x 6 paragraphs and varying valence) Shortlisting that needs to be done for production test 
14. Welcome page alignment and content update                                                                                       [DONE]
15. Update all the content based on ma'am's review and remarks/comments in google docs of content                                   [DONE]
17. Suggest Ma'am of the LLM response of PHQ, GAD page.    [Not worth it here]                                                      [DONE]
18. Thank you Page                                                                                                                  [DONE]                                                                          
19. Alignemnt of first 3 pages - welcome, instruction, consent form                                                                 [DONE]                                                              
20. Production task pages and instructions complete                                                                                 [DONE]
21. Modify the hearing question to show second one only after yes is clicked question                                               [DONE]
'''
...
def display_gender_question():
    ...
    specify_input_box = TextBox2(win, text='', pos=(0, -0.4), letterHeight=0.04, size=(0.5, 0.1), color='black')
    specify_border = visual.Rect(win, width=0.52, height=0.12, lineColor='black')
...
When you're ready, please click the 'Continue' button to begin.""",
    ...
    continue_button = visual.Rect(win, width=0.2, height=0.07, fillColor='darkgreen', pos=(0, -0.4))
    continue_button_text = visual.TextStim(win=win, text="Continue", pos=(0, -0.4), height=0.04, color='white')
...
participant_data.append(gender_response)  # Append the gender response
